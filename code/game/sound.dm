...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("bullet_hitsound")
				soundin = pick('sound/weapons/bullethit1.ogg', 'sound/weapons/bullethit2.ogg')
			if("bullet_miss")
			...
			if("generic_pickup")
				soundin = pick('sound/items/handle/pickup1.ogg','sound/items/handle/pickup2.ogg','sound/items/handle/pickup3.ogg')
	return soundin
