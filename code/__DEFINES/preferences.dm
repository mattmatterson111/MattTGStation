...
#define FULLSCREEN				(1<<16)

#define DEADMIN_ALWAYS			(1<<17)
#define DEADMIN_ANTAGONIST		(1<<18)
#define DEADMIN_POSITION_HEAD	(1<<19)
#define DEADMIN_POSITION_SECURITY	(1<<20)
#define DEADMIN_POSITION_SILICON	(1<<21)
